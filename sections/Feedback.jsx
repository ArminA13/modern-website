...
const Feedback = () => (
  ...
  >
    ...
    >
      ...
      <p className='mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[44px] leading-[38px] text-white'>“With the development of today's technology, metaverse is very useful for today's work, or can be called web 3.0. by using metaverse you can use it as anything”</p>
